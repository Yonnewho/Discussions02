# -*- coding: utf-8 -*-
"""Final Lab Examination.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1n5q9f_4wP8xHkoAffjcly6DjM-rUgL-g
"""
...
class Queue:
    # Initialize the Queue with capacity, front, rear, size, and a list to store items
...
def verticalTraversal(root):
    ...
    while not queue.isEmpty():
        ...
        # Enqueue left child with updated level
        if node.left:
            queue.enqueue((node.left, level - 1))

        # Enqueue right child with updated level
        if node.right:
